...
class ClientControlApp(ctk.CTk):
    ...
    def delete_cadastro_client(self):
        ...

    def delete_cadastro_serviço(self):
        ...

    def client_options(self):
        
        self.new_client_btn = ctk.CTkButton(self.tab_cadastro, text="Novo", command=self.new_cadastro_client)
        self.new_client_btn.grid(row=0, column=1, padx=0, pady=(20,10))

        self.update_client_btn = ctk.CTkButton(self.tab_cadastro, text="Editar", command=self.update_cadastro_client)
        self.update_client_btn.grid(row=0, column=2, padx=(0, 3), pady=(20,10))

        self.delete_client_btn = ctk.CTkButton(self.tab_cadastro, text="Exluir", command=self.delete_cadastro_client)
        self.delete_client_btn.grid(row=0, column=3, padx=2, pady=(20, 10))
